  ...
  return (
    <main>
      ...
      <div className=" mx-5 md:mx-20">
        ...
        <input className=" h-[80px] w-full bg-gray-300" type="text" />
        <div className=" mt-10">MAIL ADRESS(メールアドレス)</div>
        <input className="h-[80px] w-full bg-gray-300" type="text" />
        <div className=" mt-10">MESSAGE(メッセージ)</div>
        <input className="h-[300px] w-full bg-gray-300" type="text" />
        <div className="flex justify-center">
          <button className="my-10 flex justify-center bg-amber-700 px-10 py-3 text-white">
            送信する
          </button>
        </div>
      </div> */}
